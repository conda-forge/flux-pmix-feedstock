...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/flux-pmix-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/flux-pmix-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `flux-pmix` available on your platform:
...
```
pixi search flux-pmix --channel conda-forge
```
